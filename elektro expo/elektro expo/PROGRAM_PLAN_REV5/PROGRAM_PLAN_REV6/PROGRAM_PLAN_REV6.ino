...
void uTurnRight() {
    ...
    analogWrite(ENA, 180);
    analogWrite(ENB, 120);
    delay(550);  // Kurangi delay untuk respon yang lebih cepat
}
 ...
 switch (selectedPlan) {
        ...
        case 6:  // Plan G
            if (intersectionCounter == 1) {
                ...
                turnLeft();  // Belok kiri pada persimpangan 2
            } else if (intersectionCounter == 3) {
                turnLeft();  // Belok kiri pada persimpangan 3
            }
            break;
        ...
        case 7:  // Plan H
            if (intersectionCounter == 1) {
                ...
                turnRight();  // Belok kanan pada persimpangan 2
            } else if (intersectionCounter == 3) {
                turnRight();  // Belok kanan pada persimpangan 3
                // Setelah selesai dengan Plan H, lanjutkan ke Plan G
                selectedPlan = 6;  // Set plan ke G
                intersectionCounter = 0;  // Reset persimpangan ke 0
            }
            break;
    }
}
