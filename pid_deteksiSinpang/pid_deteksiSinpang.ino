...
// ----------- AUTO: intersection detection (no manual threshold) ----------
void checkIntersection(unsigned long now) {
  // Check outer sensors
  bool leftActive  = ((sensorValues[0] > 600 && sensorValues[0] < 710) || (sensorValues[1] > 600 && sensorValues[1] < 710));
  bool rightActive = ((sensorValues[6] > 600 && sensorValues[6] < 710) || (sensorValues[7] > 600 && sensorValues[7] < 710));
  bool centerActive =((sensorValues[3] > 600 && sensorValues[3] < 710) || (sensorValues[4] > 600 && sensorValues[4] < 710));
...
//  Serial.print(" | L="); Serial.print(leftActive);
//  Serial.print(" C="); Serial.print(centerActive);
//  Serial.print(" R="); Serial.println(rightActive);

  // Intersection condition: left + center + right all see dark line
  ...
  // Auto turn off LED after 300 ms
